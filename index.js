...
/////////////////
const  BotName  =  'HANSBOT☄' ;
const   WhatsApp   =   'https://wa.me/+62821588827133?' ;
const  telegram  =  'https://t.me/hnsran14' ;
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by Hans')
